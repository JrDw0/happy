...
export const en = {
    ...
    session: {
        ...
        renameMessage: 'Choose a title that helps you find this work later.',
        renamePlaceholder: 'Session title',
        renameFailed: 'Failed to rename session',
        actionSheetTitle: 'Session actions',
        actionGroupSession: 'Session',
        actionGroupWork: 'Continue work',
        actionGroupDeveloper: 'Developer',
        actionGroupDanger: 'Danger zone',
        sessionIdentity: 'Agent / provider / model',
    ...
    machine: {
        ...
        aiSessionHistory: 'AI Session History',
        aiSessionHistorySubtitle: 'Browse and resume AI sessions stored on this machine',
    },
    ...
    providerSessions: {
        ...
        filterAll: 'All',
        activeInHappy: 'Active in Happy',
        empty: 'No AI sessions found on this machine',
        loadFailed: 'Failed to load sessions',
        notSupported: 'This machine\'s Happy CLI does not support session history. Upgrade with `npm install -g happy-coder@latest`.',
        machineNotFound: 'Machine not found',
        notResumable: 'This session cannot be resumed',
        resumeTitle: 'Resume Session?',
        resumeMessage: ({ title }: { title: string }) => `Resume "${title}" as a new Happy session?`,
        resumeWarning: 'If the original session is still open elsewhere, resuming it here may cause conflicts.',
        resume: 'Resume',
        missingDirectoryTitle: 'Project Directory',
        missingDirectoryMessage: 'This session has no recorded directory. Enter the directory to resume in.',
