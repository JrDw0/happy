...
export const zhHant: TranslationStructure = {
    ...
    session: {
        ...
        actionSheetTitle: '工作階段操作', actionGroupSession: '工作階段', actionGroupWork: '繼續工作', actionGroupDeveloper: '開發資訊', actionGroupDanger: '危險操作', sessionIdentity: 'Agent / 提供者 / 模型',
    ...
    machine: {
        ...
        deleteFailed: '刪除裝置失敗。',
        aiSessionHistory: 'AI 工作階段歷史',
        aiSessionHistorySubtitle: '瀏覽並恢復此裝置上儲存的 AI 工作階段',
    },
    ...
    providerSessions: {
        ...
        filterAll: '全部',
        activeInHappy: '已在 Happy 中',
        empty: '此裝置上未找到 AI 工作階段',
        loadFailed: '載入工作階段失敗',
        notSupported: '此裝置的 Happy CLI 不支援工作階段歷史。請使用 `npm install -g happy-coder@latest` 升級。',
        machineNotFound: '未找到裝置',
        notResumable: '此工作階段無法恢復',
        resumeTitle: '恢復工作階段？',
        resumeMessage: ({ title }: { title: string }) => `將「${title}」恢復為新的 Happy 工作階段？`,
        resumeWarning: '如果原工作階段仍在其他地方執行，在此恢復可能產生衝突。',
        resume: '恢復',
        missingDirectoryTitle: '專案目錄',
        missingDirectoryMessage: '此工作階段沒有記錄目錄。請輸入要在其中恢復的目錄。',
    ...
    imageUpload: {
        ...
        cameraPermissionMessage: '允許存取相機，以便拍攝照片加入訊息。',
        takePhoto: '拍照',
        chooseMedia: '選擇照片和影片',
        addFile: '加入檔案',
        command: '命令',
