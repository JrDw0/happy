...
export const zhHans: TranslationStructure = {
    ...
    session: {
        ...
        rename: '重命名会话',
        renameTitle: '重命名会话',
        renameMessage: '设置一个便于之后查找的会话标题。',
        renamePlaceholder: '会话标题',
        renameFailed: '重命名会话失败',
        actionSheetTitle: '会话操作',
        actionGroupSession: '会话',
        actionGroupWork: '继续工作',
        actionGroupDeveloper: '开发信息',
        actionGroupDanger: '危险操作',
        sessionIdentity: 'Agent / 提供商 / 模型',
    ...
    machine: {
        ...
        deleteFailed: '删除设备失败。',
        aiSessionHistory: 'Agents 会话历史',
        aiSessionHistorySubtitle: '浏览并恢复此设备上存储的Agents 会话',
    },
    ...
    providerSessions: {
        ...
        empty: '此设备上未找到 Agents 会话',
        loadFailed: '加载会话失败',
        notSupported: '此设备的 Happy CLI 不支持会话历史。请使用 `npm install -g happy-coder@latest` 升级。',
        machineNotFound: '未找到设备',
        notResumable: '此会话无法恢复',
        resumeTitle: '恢复会话？',
        resumeMessage: ({ title }: { title: string }) => `将"${title}"恢复为新的 Happy 会话？`,
        resumeWarning: '如果原会话仍在其他地方运行，在此恢复可能产生冲突。',
        resume: '恢复',
        missingDirectoryTitle: '项目目录',
        missingDirectoryMessage: '此会话没有记录目录。请输入要在其中恢复的目录。',
        resumeFailed: '恢复会话失败',
        sortRecent: '最近活跃',
        sortCreated: '创建时间',
        sortProject: '按项目',
    ...
    imageUpload: {
        ...
        cameraPermissionMessage: '允许访问相机，以便拍摄照片添加到消息。',
        takePhoto: '拍照',
        chooseMedia: '选择照片和视频',
        addFile: '添加文件',
        command: '命令',
