...
export const it: TranslationStructure = {
    ...
    session: {
        ...
        actionSheetTitle: 'Azioni sessione', actionGroupSession: 'Sessione', actionGroupWork: 'Continua lavoro', actionGroupDeveloper: 'Sviluppatore', actionGroupDanger: 'Zona pericolosa', sessionIdentity: 'Agente / provider / modello',
    ...
    machine: {
        ...
        aiSessionHistory: 'Cronologia sessioni IA',
        aiSessionHistorySubtitle: 'Sfoglia e riprendi le sessioni IA salvate su questa macchina',
    },
    ...
    providerSessions: {
        ...
        filterAll: 'Tutte',
        activeInHappy: 'Attiva in Happy',
        empty: 'Nessuna sessione IA trovata su questa macchina',
        loadFailed: 'Impossibile caricare le sessioni',
        notSupported: 'Il Happy CLI di questa macchina non supporta la cronologia delle sessioni. Aggiorna con `npm install -g happy-coder@latest`.',
        machineNotFound: 'Macchina non trovata',
        notResumable: 'Questa sessione non può essere ripresa',
        resumeTitle: 'Riprendere la sessione?',
        resumeMessage: ({ title }: { title: string }) => `Riprendere "${title}" come nuova sessione Happy?`,
        resumeWarning: 'Se la sessione originale è ancora aperta altrove, riprenderla qui può causare conflitti.',
        resume: 'Riprendi',
        missingDirectoryTitle: 'Directory del progetto',
        missingDirectoryMessage: 'Questa sessione non ha una directory registrata. Inserisci la directory in cui riprenderla.',
        ...
        dateToday: 'Oggi',
        date7Days: '7 giorni',
        date30Days: '30 giorni',
        date90Days: '90 giorni',
        detailEmpty: 'Nessun messaggio in questa sessione',
        loadEarlier: 'Carica messaggi precedenti',
        openInHappy: 'Apri in Happy',
        filterTitle: 'Filtra e ordina',
